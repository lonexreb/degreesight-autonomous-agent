...
argument-hint: <notion-url> [--model sonnet|opus|haiku] [--budget 50]
---
...
5. **Execute each task**:
   ...
   - Report progress
6. **Summarize**: tasks completed, tasks failed, any questions for the user

## Example

```
/morningstar:run https://notion.so/My-PRD-abc123 --model opus --budget 100
```
